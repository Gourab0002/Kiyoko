...
function mirrors(): string[] {
  const urls = [Constants.SukebeiBaseUrl, Constants.SukebeiAltUrl];
  return [...new Set(urls.filter(Boolean))];
}

export async function fetchSukebei(path: string): Promise<FetchResult> {
