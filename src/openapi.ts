...
export const openApiSpec = {
  ...
  info: {
    ...
    description:
      "Read-only JSON API for public Sukebei listing, view, user, and RSS pages. List endpoints keep returning a torrent array by default; pass envelope=1 for pagination metadata.",
  },
  paths: {
    "/": {
      get: {
    ...
    "/search": {
      get: {
        ...
        parameters: [
          ...
          { name: "c", in: "query", description: "Sukebei id (1_2) or category path (art/doujinshi)", schema: { type: "string" } },
